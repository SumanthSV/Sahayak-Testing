...
const LessonPlanner: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">Plan and organize lessons for multiple grade levels</p>
            </div>
          </div>
          <motion.button
        ...
        <div className="grid grid-cols-7 gap-4">
          {weekDays.map((day, index) => (
            <motion.div
              ...
              className="bg-gray-50 rounded-xl p-4 min-h-[120px]"
            >
                ...
                {formData.objectives.map((objective, index) => (
                  <div key={index} className="flex items-center space-x-2 mb-2">
                    <input
                      ...
                      className="flex-1 p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white/50 backdrop-blur-sm"
                    />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-24 p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none bg-white/50 backdrop-blur-sm"
                />
              </div>
      ...
      >
        <h2 className="text-xl font-semibold text-gray-800 mb-6">All Lesson Plans</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {lessonPlans.map((plan) => (
              <motion.div
                ...
                whileHover={{ scale: 1.02 }}
                className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition-all duration-200 cursor-pointer bg-white/50 backdrop-blur-sm"
                onClick={() => startEditing(plan)}
              >
