...
const Header: React.FC = () => {
  ...
  return (
    <motion.header
      ...
      className="bg-white/80 backdrop-blur-lg border-b border-gray-200/50 px-6 py-4 relative z-40"
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="relative p-2 rounded-xl bg-gray-100/50 hover:bg-gray-200/50 transition-all duration-200"
          >
