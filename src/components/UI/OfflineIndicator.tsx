  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed top-0 left-0 right-0 bg-gradient-to-r ${getStatusColor()} text-white z-50 shadow-lg`}
      >
        <div className="container-responsive">
          <motion.button
            onClick={() => setIsExpanded(!isExpanded)}
            className="w-full py-3 px-4 flex items-center justify-between hover:bg-black/10 transition-colors duration-200"
